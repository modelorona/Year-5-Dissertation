...
public class FactorInteraction implements Term {
    ...
    public String toString() {
        ...
        factors.forEach(s -> {
            combinedFactors.append(s).append(":");
        });
        combinedFactors.deleteCharAt(combinedFactors.length() - 1);
        combinedFactors.trimToSize();
        return combinedFactors.toString();
    }
