...
public class IntFunction extends AbstractFunction {
     ...
     */
    private final com.anguel.dissertation.ml.smile.math.IntFunction lambda;
     ...
     */
    public IntFunction(String name, Term x, com.anguel.dissertation.ml.smile.math.IntFunction lambda) {
        super(name, x);
        this.lambda = lambda;
    }
