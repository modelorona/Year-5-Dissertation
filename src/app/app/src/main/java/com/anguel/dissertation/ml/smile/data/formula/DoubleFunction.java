...
public class DoubleFunction extends AbstractFunction {
     ...
     */
    private final com.anguel.dissertation.ml.smile.math.Function lambda;
     ...
     */
    public DoubleFunction(String name, Term x, com.anguel.dissertation.ml.smile.math.Function lambda) {
        super(name, x);
        this.lambda = lambda;
    }
